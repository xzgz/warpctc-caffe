...
#include "caffe/util/ssd_im_transforms.hpp"
...
SSDDataTransformer<Dtype>::SSDDataTransformer(const SSDTransformationParameter& param,
    Phase phase)
...
template<typename Dtype>
void SSDDataTransformer<Dtype>::Transform(const vector<Datum> & datum_vector,
                                       Blob<Dtype>* transformed_blob) {
...
#ifdef USE_OPENCV
template<typename Dtype>
void SSDDataTransformer<Dtype>::Transform(const vector<cv::Mat> & mat_vector,
                                       Blob<Dtype>* transformed_blob) {
...
template<typename Dtype>
void SSDDataTransformer<Dtype>::Transform(Blob<Dtype>* input_blob,
                                       Blob<Dtype>* transformed_blob) {
  const int crop_size = param_.crop_size();
...
template<typename Dtype>
vector<int> SSDDataTransformer<Dtype>::InferBlobShape(
...
template <typename Dtype>
void SSDDataTransformer<Dtype>::InitRand() {
