#ifndef SSD_CAFFE_MULTIBOX_LOSS_LAYER_HPP_
#define SSD_CAFFE_MULTIBOX_LOSS_LAYER_HPP_
...
class MultiBoxLossLayer : public LossLayer<Dtype> {
 ...
 protected:
  ...
  SSDMultiBoxLossParameter ssd_multibox_loss_param_;
  int num_classes_;
...
#endif  // SSD_CAFFE_MULTIBOX_LOSS_LAYER_HPP_
