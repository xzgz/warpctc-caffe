#ifndef SSD_CAFFE_PERMUTE_LAYER_HPP_
#define SSD_CAFFE_PERMUTE_LAYER_HPP_
...
template <typename Dtype>
class SSDPermuteLayer : public Layer<Dtype> {
 public:
  explicit SSDPermuteLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "SSDPermute"; }
...
#endif  // SSD_CAFFE_PERMUTE_LAYER_HPP_
