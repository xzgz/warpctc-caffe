...
class SSDDataTransformer {
 public:
  explicit SSDDataTransformer(const SSDTransformationParameter& param, Phase phase);
 ...
 protected:
  ...
  SSDTransformationParameter param_;
...
#endif  // CAFFE_SSD_DATA_TRANSFORMER_HPP
